    ...
    <>
      ...
      <section className="relative bg-gradient-to-br from-[#406386] via-[#2d4a67] to-[#1a3447] py-12 sm:py-16 lg:py-20 overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('/assets/image/static/hero/image_company_profile_kontak_hero.jpg')",
          }}
        ></div>
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div
            className="absolute w-12 h-12 rounded-full top-12 left-6 bg-white/10 animate-bounce sm:w-16 sm:h-16 sm:top-16 sm:left-8 lg:w-20 lg:h-20 lg:top-20 lg:left-10"
            style={{ animationDelay: "0s", animationDuration: "3s" }}
          ></div>
          <div
            className="absolute w-10 h-10 rounded-full top-24 right-12 bg-blue-200/20 animate-bounce sm:w-12 sm:h-12 sm:top-32 sm:right-16 lg:w-16 lg:h-16 lg:top-40 lg:right-20"
            style={{ animationDelay: "1s", animationDuration: "4s" }}
          ></div>
          <div
            className="absolute w-8 h-8 rounded-full bottom-20 left-1/4 bg-white/15 animate-bounce sm:w-10 sm:h-10 sm:bottom-24 lg:w-12 lg:h-12 lg:bottom-32"
            style={{ animationDelay: "2s", animationDuration: "5s" }}
          ></div>
          <div
            className="absolute w-6 h-6 rounded-full top-1/3 right-1/3 bg-blue-100/25 animate-bounce sm:w-8 sm:h-8"
        ...
        <div className="container relative px-4 mx-auto sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="max-w-3xl px-2 mx-auto mb-6 text-sm leading-relaxed text-blue-100 sm:text-base lg:text-lg xl:text-xl sm:mb-8">
              Kontak kami untuk mendapatkan informasi lebih lanjut tentang
              program Beasiswa Bersekolah. Kami siap membantu Anda dengan segala
              pertanyaan dan kebutuhan informasi.
            </p>
      ...
      <section
        ...
        className="py-12 bg-gradient-to-b from-gray-50 to-white sm:py-16 lg:py-20"
      >
        <div className="container px-4 mx-auto sm:px-6 lg:px-8">
          <div className="mb-8 text-center sm:mb-12">
            ...
            <p className="max-w-2xl mx-auto text-sm text-gray-600 sm:text-base">
              Kami siap membantu menjawab pertanyaan Anda seputar program
              Beasiswa Bersekolah
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="overflow-hidden border-0 shadow-xl bg-gradient-to-br from-white to-blue-50 rounded-2xl sm:rounded-3xl transition-all duration-300 hover:shadow-2xl">
              ...
              <div className="absolute inset-0 overflow-hidden">
                <div className="absolute top-0 right-0 w-24 h-24 opacity-10 sm:w-32 sm:h-32 lg:w-40 lg:h-40">
                  <svg
                    ...
                    fill="currentColor"
                    className="text-[#406386] w-full h-full"
                    viewBox="0 0 24 24"
                  >
                ...
                <div
                  className="absolute w-10 h-10 rounded-full bottom-6 left-6 bg-blue-200/20 animate-bounce sm:w-12 sm:h-12 sm:bottom-8 sm:left-8 lg:w-16 lg:h-16 lg:bottom-10 lg:left-10"
                  style={{ animationDelay: "1s", animationDuration: "4s" }}
                ></div>
              </div>
              ...
              <CardContent className="relative z-10 p-4 sm:p-6 lg:p-8 xl:p-10">
                ...
                {notification.show && (
                  <div
                    className={`mb-6 p-3 rounded-lg sm:mb-8 sm:p-4 sm:rounded-xl ${
                    ...
                    <div className="flex">
                      <div className="flex-shrink-0">
                        {notification.type === "success" ? (
                          ...
                          <svg
                            className="w-4 h-4 text-red-500 sm:w-5 sm:h-5"
                            fill="currentColor"
                            viewBox="0 0 20 20"
                          >
                            <path
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    <div className="grid gap-4 sm:gap-6 md:grid-cols-2">
                      <div className="transition-all duration-200 group">
                        <label
                          htmlFor="nama"
                          className="block mb-1 text-xs font-medium text-gray-700 group-hover:text-[#406386] sm:mb-2 sm:text-sm"
                        >
                          Nama
                        </label>
                        <Input
                        ...
                        >
                          {isSubmitting ? (
                            <div className="flex items-center justify-center">
                              <svg
                                className="w-4 h-4 mr-2 animate-spin sm:w-5 sm:h-5"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor"
                              >
