...
import CornerEasterEgg from './CornerEasterEgg';
  ...
  const contactInfo = [
    {
      icon: Mail,
      label: 'Email',
      value: 'beasiswabersekolah@gmail.com',
      href: 'mailto:beasiswabersekolah@gmail.com'
    },
    {
      icon: Phone,
      label: 'Telepon',
        ...
        <div className="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4 lg:gap-12">
            ...
            <div className="lg:col-span-1">
              <div className="mb-4">
                <img src="/storage/bersekolah.png" alt="Bersekolah Logo" className="w-auto h-12" />
              </div>
