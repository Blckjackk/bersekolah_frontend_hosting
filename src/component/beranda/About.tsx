    ...
    <section className="px-4 py-12 md:py-16 sm:px-6 lg:px-8 bg-slate-50">
      <div className="mx-auto max-w-screen-xl">
        ...
        <div className="flex flex-col gap-8 justify-center items-center md:flex-row md:gap-12">
          ...
          >
            <img
              src="/assets/image/static/about/image_home_about_beasiswa.jpg"
          ...
          <div className="w-full md:w-3/5">
            ...
            <p className="mb-6 text-base leading-relaxed text-gray-700 md:text-lg">
              Bersekolah adalah bentuk nyata dari kepedulian terhadap masa depan
              pendidikan Indonesia. Lebih dari sekadar bantuan finansial,
              program ini hadir untuk menyalakan semangat belajar siswa di
              seluruh penjuru negeri. Melalui dukungan rutin berupa uang
              pembinaan dan pendampingan inspiratif, Beasiswa Bersekolah menjadi
              teman tumbuh bagi para pelajar agar terus melangkah maju, percaya
